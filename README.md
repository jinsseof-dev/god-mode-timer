...
### 14단계: 기능 확장 및 글로벌화 (v1.21)
- [x] **다국어 지원 (Localization)**: 한국어/영어 등 다국어 UI 지원 (i18n)
- [x] **사용성 개선**: 콘솔 창 숨김 및 폴더 구조 최적화
- [ ] **통계 고도화**: 주간/월간 뷰 전환 및 기록 수정/삭제 기능
